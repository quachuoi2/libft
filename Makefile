...
NAME = libft.a
SRCS = ft_arrdel ft_atoi ft_bzero ft_calloc ft_countwords ft_diglen ft_isspace\
...
ft_putendl_fd ft_putendl ft_putnbr_fd ft_putnbr ft_putstr ft_putstr_fd \
