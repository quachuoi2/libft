...
#    Updated: 2022/03/07 17:46:14 by qnguyen          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a
SRCS = ft_abs ft_arrdel ft_atoi ft_bzero ft_calloc ft_countwords ft_d2base ft_diglen \
ft_udiglen ft_greaternum ft_isspace\
