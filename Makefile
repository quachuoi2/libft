...
#    Updated: 2022/02/06 23:34:17 by qnguyen          ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = libft.a
SRCS = ft_arrdel ft_atoi ft_bzero ft_calloc ft_countwords ft_d2base ft_diglen \
ft_isspace\
...
ft_putendl_fd ft_putendl ft_putfloat \
ft_putnbr_fd ft_putnbr ft_putstr ft_putstr_fd ft_sqrt\
